  ...
  if (contactForm) {
    ...
    function getErrorMessage(field) {
      ...
      if (field.tagName === 'SELECT' && field.required && field.value === '') {
        return field.dataset.errorRequired || 'Please select an option.';
      }
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      if (isValid) {
        ...
        fetch(action, {
          ...
          .catch(function () {
            const errorBanner = contactForm.querySelector('.form-error-banner');
            if (errorBanner) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '8fbefe98-b01d-4607-a18d-50ab0d344325',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '8fbefe98-b01d-4607-a18d-50ab0d344325';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '8fbefe98-b01d-4607-a18d-50ab0d344325';
